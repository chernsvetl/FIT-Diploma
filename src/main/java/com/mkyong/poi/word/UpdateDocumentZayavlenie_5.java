...
public class UpdateDocumentZayavlenie_5 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        obj.updateDocument(
                ...
                "src/main/resources/5sem/bak.docx",
                "Пальчунову Дмитрию Евгеньевичу",
                "19204",
                "Чернявцева Светлана Игоревна");
...
//                "19204");
    ...
    void updateDocument(String input, String output, String head, String group, String fio) throws IOException {
        ...
        try (InputStream is = getFileFromResource(input);
            ...
            for (XWPFParagraph xwpfParagraph : xwpfParagraphList) {
                for (XWPFRun xwpfRun : xwpfParagraph.getRuns()) {
                    ...
                    docText = docText.replace("${head}", head);
                    docText = docText.replace("${group}", group);
                    docText = docText.replace("${fio}", fio);
