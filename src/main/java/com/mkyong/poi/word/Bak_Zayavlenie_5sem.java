...
public class Bak_Zayavlenie_5sem  {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (XWPFDocument doc = new XWPFDocument()) {
            ...
            r1.setItalic(false);
            r1.setFontSize(12);
            r1.setText("Заведующему кафедрой ${head}");
            ...
            r2.setItalic(false);
            r2.setFontSize(12);
            r2.setText("обучающегося факультета информационных технологий");
 ...
 */
            ...
            r3.setItalic(false);
            r3.setFontSize(12);
            r3.setText("3 курса, группы №${group}");
            ...
            r4.setItalic(false);
            r4.setFontSize(12);
            r4.setText("направленность (профиль) Программная инженерия и компьютерные науки");
...
*/
            ...
            // save the docs
            try (FileOutputStream out = new FileOutputStream("C:\\Users\\User\\Desktop\\Диплом\\template\\apache-poi-examples\\src\\main\\resources\\5sem\\zayavlenie_5sem_template.docx")) {
                doc.write(out);
            }
